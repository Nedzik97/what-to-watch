...
import { FilmsList } from '../../components/films-list.tsx/films-list';
import { Logo } from '../../components/logo/logo';
import { UserBlock } from '../../components/user-block/user-block';
import { useAppDispatch, useAppSelector } from '../../hooks';
import { getFavoriteFilms, getFavoriteFilmsAmount, getFavoriteFilmsStatus } from '../../store/favorite-film-data/selectors';
